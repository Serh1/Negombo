            ...
            <div class="card-body">
              ...
              <form action="{{ route('admin.booking.updatebookingdelaits') }}" method="POST">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-md-6">
                          <div class="t-datepicker" id="booking_day_start">
                            {{-- <span class="t-check-in" name="booking_day_start"></span> --}}
                            <input type="date" id="edit_numberofdays" style="width:60%;"  data-date-inline-picker="true" value="{{ $Booking->user_checkin }}" name="user_checkin" />
                            <input id="edit_numberofdays" style="width:120px;" type="number" min="1" name="numberofDays" value={{ $Booking->numberOfDays() }} required></div>
                        </div>
                  </div>
