                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.promocodes.add') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="numberofadults" id="disable" type="number" class="form-control" name="numberofadults" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="numberofbabies" id="disable" type="number" class="form-control" name="numberofbabies" required>
                            </div>
