                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.promocodes.update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="numberofadults" type="number" class="form-control" name="numberofadults" value="{{ $promo->numberofadults }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="numberofbabies" type="number" class="form-control" name="numberofbabies" value="{{ $promo->numberofbabies }}" required>
                            </div>
