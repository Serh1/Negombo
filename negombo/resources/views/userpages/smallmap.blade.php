            ...
            <div class="col-sm-8 offset-sm-1">
                ...
                <form action="" method="GET">
                    ...
                    <noscript>
                        ...
                        <li ><span><a target="blank" href="https://www.enable-javascript.com/it/">{{ _('Instructions how to enable JavaScript in your web browser') }}.</a></span></li><br><br>
                    </noscript>
                        ...
                        <div class="col-sm-8 col-12">
                          ...
                          {{-- <input class="cal_style" placeholder="DD/MM/YYYY" type="date" id="t_start" name="t_start" min='{{ $startday }}' max='{{ $endday }}'> --}}
                            ...
                            @isset($maparray['err_msg'])
                                <span id="errormsg_txt" style="color:red;"> {{ _('You can book maximum') }} {{ $maparray["set_admin"]->max_no_days }} {{ _('days') }}.</span><br>
                            @endisset
