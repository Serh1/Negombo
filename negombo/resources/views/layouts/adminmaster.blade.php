...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-primary">
        ...
        <a class="navbar-brand" href="{{ route('admin') }}">
            <img src="{{ asset('images/siteimages/logo-color.svg') }}" width="200" height="30"
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ml-auto">
                ...
                <li>
                    <a class="nav-link" href="{{ route('user.index') }}">{{ __('Main Home') }}</a>
                </li>
                @endguest
                </li>
                @auth
    ...
    <div class="row" id="body-row">
        ...
        <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
            ...
            <ul class="list-group">
                ...
                <!-- /END Separator -->
                <button data-toggle="sidebar-colapse"
                ...
                <div id='submenu1' class="collapse sidebar-submenu">
                    <a href="{{ route('admin.place.viewplaces') }}"
                ...
                <div id='submenu2' class="collapse sidebar-submenu">
                    <a href="{{ route('admin.booking.viewbookings') }}"
                        class="list-group-item list-group-item-action bg-dark text-white">
                        <span class="menu-collapsed">View Bookings</span>
                    </a>
                    <a href="{{ route('admin.viewbookings.all') }}"
                        class="list-group-item list-group-item-action bg-dark text-white">
                        <span class="menu-collapsed">Previous Bookings</span>
                    </a>
                    <a href="{{ route('admin.booking.entrance') }}"
                        class="list-group-item list-group-item-action bg-dark text-white">
                        {{-- <span class="menu-collapsed">Transactions<span
                                class="badge badge-pill badge-primary ml-2">pro</span></span> --}}
                        <span class="menu-collapsed">Entrance</span>
                    </a>
                    <a href="{{ route('admin.booking.subscription') }}"
                        class="list-group-item list-group-item-action bg-dark text-white">
                ...
                @if (Auth::user()->role == "admin")
                <a href="{{ route('admin.booking.transaction') }}"
        ...
        <div class="col">
            ...
            <footer class="page-footer font-small bg-primary marginTop20">
                ...
                <!-- Copyright -->
                <div class="footer-copyright text-center py-3">© 2020-<script>
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery-mockjax/1.6.2/jquery.mockjax.min.js">
</script>
