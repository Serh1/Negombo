...
function cnvs_getCoordinates_small(e){
    ...
    function addFieldsadmin2(numoffld){
      ...
      for (var i = 0; i < numoffld; i++) {
          val = i+1;
          $(wrapper).append('<div class="form-group row dyinpfld2"> <label for="surename" class="col-md-4 col-form-label text-md-right">Ospite Bambino '+val+' Nome Cognome:</label> <div class="col-md-6"> <input class="form-control booking_inp_textbox_style" type="text" name="guestnamesbabies[]"/></div></div>');
      }
    }
