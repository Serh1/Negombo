...
- The **Developer** is `Shaykh Siddique`, `developer jurisdiction` (ISO 3166-2), `e-mail:shaykhsiddiqee@gmail.com`.

- The **Agent** is `Negombo`, `agent jurisdiction` (ISO 3166-2), `https://negombo.it/`.
...
The _Developer_ licenses the _User_ for the _Term_ to do everything with the _Licensed Contributions_ that would otherwise infringe the _Developer_'s copyright in them as well as the _Agent_.
